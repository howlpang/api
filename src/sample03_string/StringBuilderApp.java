...
public class StringBuilderApp {
	...
	public static void main(String[] args) {
		...
		// - 문자열에 대한 변경이 발생하더라도 새 객체가 생성되지 않고, 객체내부의 임시저장소에 변경내용이 반영된다.
		// - 주요 메소드
		...
		//아래의 코드를 실행하면, String객체는 매번 새로운 객체가 생성되기 때문에 hashcode값이 각각 다르게 출력되고,
		//StringBuilder는 문자열을 추가해도 객체가 새로 생성되지 않는다.
