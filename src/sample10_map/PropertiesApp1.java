...
public class PropertiesApp1 {
	...
	public static void main(String[] args)  throws IOException{
		 ...
		 *  	String getProperty(Strint key, String defaultValue)
		 *  		-지정된 key값에 해당하는 프로퍼티정보를 반환한다.
...
//		prop.load(new FileInputStream("/Users/howlpang/eclipse-workspace/api/src/sample10_map/sample.properties"));
		prop.loadFromXML(new FileInputStream("/Users/howlpang/eclipse-workspace/api/src/sample10_map/sample.xml"));
